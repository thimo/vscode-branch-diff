...
`extension.js` / `package.json` into the installed folder under
`~/.vscode/extensions/` and reload the main window. Only needed if you want
the change live in your normal editor without F5.
